...
use Bnw\Tools\Commands\ToolsCommand;
use Bnw\Tools\Http\Controllers\AbcControlller;
use Bnw\Tools\Http\Controllers\Teste;
use Bnw\Tools\Http\Controllers\TesteController;
...
class ServiceProvider extends BaseServiceProvider
{
    ...
    public function register()
    {
        ...
        // deve-se usar @include('tools::minha.linda.view')
        $this->loadViewsFrom(__DIR__ . '/Resources/views/', 'tools');
        
        //$this->loadMigrationsFrom(__DIR__ . '/database/migrations/', 'tools');
